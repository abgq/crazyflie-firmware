...
#define SAR_TEMP_TO_CELCIUS_CONV (1.14f)
#define SAR_VBAT_TO_VOLT_CONV (1.0f/173.0f)

#define DCELCIUS_TO_SAR_TEMP_CONV ((int)((0.10f/1.14f)*256.0f))
#define MVOLT_TO_SAR_VBAT_CONV (173.0f/1000.0f)
