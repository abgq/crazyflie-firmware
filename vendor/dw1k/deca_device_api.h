...
#define DWT_IDLE_ON_DLY_ERR                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \
    2 // If delayed RX failed due to "late" error then if this
      // flag is set the RX will not be re-enabled immediately, and device will be in IDLE when function exits
#define DWT_NO_SYNC_PTRS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
    4 // Do not try to sync IC side and Host side buffer pointers when enabling RX. This is used to perform manual RX
...
#define DWT_INT_RXDFR  0x00002000 /*!< RX Success Event */
 ...
 * no return value
 */
void dwt_writetodevice(uint16 recordNumber, // input parameter - ID of register file or buffer being accessed
 ...
 * no return value
 */
void dwt_readfromdevice(uint16 recordNumber, // input parameter - ID of register file or buffer being accessed
                        uint16 index,        // input parameter - byte index into register file or buffer being accessed
